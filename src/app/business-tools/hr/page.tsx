...
import { ArrowLeft, ExternalLink, UserCog, Share2, Heart } from 'lucide-react';
...
const hrTools = [
  {
    name: 'Gusto',
    description: 'The all-in-one people platform for payroll, benefits, and more.',
    url: 'https://gusto.com/',
    image: 'https://picsum.photos/seed/gusto/600/400',
    dataAiHint: 'payroll platform'
  },
  {
    name: 'Zenefits',
    description: 'The all-in-one HR platform for small businesses.',
    url: 'https://www.zenefits.com/',
    image: 'https://picsum.photos/seed/zenefits/600/400',
    dataAiHint: 'hr platform'
  },
  {
    name: 'ADP',
    description: 'HR and payroll solutions for businesses of all sizes.',
    url: 'https://www.adp.com/',
    image: 'https://picsum.photos/seed/adp/600/400',
    dataAiHint: 'payroll solutions'
  },
];
...
export default function HrToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof hrTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
