...
import { ArrowLeft, ExternalLink, Lightbulb, Share2, Heart } from 'lucide-react';
...
export default function BusinessPlanningToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof businessPlanningTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
