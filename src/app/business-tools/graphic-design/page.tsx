...
const graphicDesignTools = [
  {
    name: 'Canva',
    description: 'Amazingly simple graphic design software.',
    url: 'https://www.canva.com/',
    image: 'https://picsum.photos/seed/canva/600/400',
    dataAiHint: 'design tool'
  },
  {
    name: 'Visme',
    description: 'Create presentations, infographics, and other visual content.',
    url: 'https://www.visme.co/',
    image: 'https://picsum.photos/seed/visme/600/400',
    dataAiHint: 'visual content'
  },
  {
    name: 'DesignWizard',
    description: 'Create impressive videos and image designs in minutes.',
    url: 'https://www.designwizard.com/',
    image: 'https://picsum.photos/seed/designwizard/600/400',
    dataAiHint: 'image design'
  },
];
