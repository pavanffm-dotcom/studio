...
import { ArrowLeft, ExternalLink, Video, Share2, Heart } from 'lucide-react';
...
export default function VideoConferencingToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof videoConferencingTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
