...
import { ArrowLeft, ExternalLink, BarChart, Share2, Heart } from 'lucide-react';
...
const salesTools = [
  {
    name: 'Clearbit',
    description: 'Marketing data engine for all of your customer interactions.',
    url: 'https://clearbit.com/',
    image: 'https://picsum.photos/seed/clearbit/600/400',
    dataAiHint: 'data enrichment'
  },
  {
    name: 'Hunter',
    description: 'Find professional email addresses in seconds.',
    url: 'https://hunter.io/',
    image: 'https://picsum.photos/seed/hunter/600/400',
    dataAiHint: 'email finder'
  },
  {
    name: 'LinkedIn Sales Navigator',
    description: 'Build and nurture sales relationships.',
    url: 'https://www.linkedin.com/sales/index',
    image: 'https://picsum.photos/seed/linkedin-sales/600/400',
    dataAiHint: 'sales network'
  },
];
...
export default function SalesToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof salesTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
