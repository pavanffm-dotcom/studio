...
import { 
    ArrowLeft, ExternalLink, Star, Share2, DollarSign, UserCog, CreditCard, Users, MessageSquare, Video, TrendingUp, Megaphone, BarChart, Code, Server, Layers, GitBranch, ListChecks, Lightbulb, Cpu, Briefcase, Filter
} from 'lucide-react';
