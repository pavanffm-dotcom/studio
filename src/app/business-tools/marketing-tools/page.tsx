...
import { ArrowLeft, ExternalLink, Megaphone, Share2, Heart } from 'lucide-react';
...
const marketingTools = [
  {
    ...
    image: 'https://picsum.photos/seed/mailchimp/600/400',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/hootsuite/600/400',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/googleanalytics/600/400',
...
export default function MarketingToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof marketingTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
