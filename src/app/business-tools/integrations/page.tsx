...
import { ArrowLeft, ExternalLink, Link2, Share2, Heart } from 'lucide-react';
...
export default function IntegrationsToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof integrationsTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
