...
import { ArrowLeft, ExternalLink, Calendar, Share2, Heart } from 'lucide-react';
...
const schedulingTools = [
  {
    ...
    image: 'https://picsum.photos/seed/calendly/600/400',
    dataAiHint: 'calendar appointment'
  },
  {
    name: 'You Can Book Me',
    description: 'Online scheduling for customer bookings.',
    url: 'https://youcanbook.me/',
    image: 'https://picsum.photos/seed/youcanbookme/600/400',
    dataAiHint: 'booking page'
  },
  {
    name: 'Setmore',
    description: 'Free appointment scheduling software.',
    url: 'https://www.setmore.com/',
    image: 'https://picsum.photos/seed/setmore/600/400',
    dataAiHint: 'scheduling app'
  },
];
...
export default function SchedulingToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof schedulingTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
