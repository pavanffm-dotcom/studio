...
import { ArrowLeft, ExternalLink, DollarSign, Share2, Heart } from 'lucide-react';
...
const accountingTools = [
  {
    name: 'FreshBooks',
    description: 'Accounting software built for owners, and their clients.',
    url: 'https://www.freshbooks.com/',
    image: 'https://picsum.photos/seed/freshbooks/600/400',
    dataAiHint: 'accounting software'
  },
  {
    name: 'QuickBooks',
    description: 'Smart, simple accounting software for small business.',
    url: 'https://quickbooks.intuit.com/',
    image: 'https://picsum.photos/seed/quickbooks/600/400',
    dataAiHint: 'business accounting'
  },
  {
    name: 'Xero',
    description: 'Online accounting software for your business.',
    url: 'https://www.xero.com/',
    image: 'https://picsum.photos/seed/xero/600/400',
    dataAiHint: 'online accounting'
  },
];
...
export default function AccountingToolsPage() {
    ...
    const handleShareTool = React.useCallback(async (e: React.MouseEvent, tool: typeof accountingTools[0]) => {
        e.preventDefault();
        e.stopPropagation();
