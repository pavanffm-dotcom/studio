...
export const businessToolData: ToolCategory[] = [
    ...
    },
    {
        ...
        tools: [
            ...
            { name: 'Dropbox', description: 'Focus on the work that matters.', url: 'https://www.dropbox.com/', image: 'https://picsum.photos/seed/dropbox-prod/600/400', dataAiHint: 'file sync', pricing: 'Freemium' },
            { name: 'OneDrive', description: 'Save your files and photos to OneDrive and access them from any device, anywhere.', url: 'https://onedrive.live.com/', image: 'https://picsum.photos/seed/onedrive-prod/600/400', dataAiHint: 'microsoft cloud', pricing: 'Freemium' },
        ]
    },
    {
    ...
    },
    {
        ...
        tools: [
            { name: 'Mailchimp', description: 'Marketing automation and email marketing service.', url: 'https://mailchimp.com/', image: 'https://picsum.photos/seed/mailchimp-prod/600/400', dataAiHint: 'email campaigns', pricing: 'Freemium' },
            { name: 'SEMrush', description: 'Online visibility management and content marketing platform.', url: 'https://www.semrush.com/', image: 'https://picsum.photos/seed/semrush-prod/600/400', dataAiHint: 'seo tools', pricing: 'Paid' },
            { name: 'Ahrefs', description: 'All-in-one SEO toolset.', url: 'https://ahrefs.com/', image: 'https://picsum.photos/seed/ahrefs-prod/600/400', dataAiHint: 'backlink analysis', pricing: 'Paid' },
        ]
    },
    {
        ...
        tools: [
            { name: 'QuickBooks', description: 'Smart, simple accounting software.', url: 'https://quickbooks.intuit.com/', image: 'https://picsum.photos/seed/quickbooks/600/400', dataAiHint: 'small business', pricing: 'Paid' },
            ...
            { name: 'FreshBooks', description: 'Accounting software built for owners.', url: 'https://www.freshbooks.com/', image: 'https://picsum.photos/seed/freshbooks/600/400', dataAiHint: 'invoicing software', pricing: 'Paid' },
        ]
    },
    {
        ...
        tools: [
            { name: 'BambooHR', description: 'The #1 online HR software for small and medium businesses.', url: 'https://www.bamboohr.com/', image: 'https://picsum.photos/seed/bamboohr/600/400', dataAiHint: 'hr software', pricing: 'Paid' },
            { name: 'Gusto', description: 'The all-in-one platform for payroll, benefits, and HR.', url: 'https://gusto.com/', image: 'https://picsum.photos/seed/gusto/600/400', dataAiHint: 'payroll benefits', pricing: 'Paid' },
            { name: 'Rippling', description: 'The first way for businesses to manage all of their HR & IT.', url: 'https://www.rippling.com/', image: 'https://picsum.photos/seed/rippling/600/400', dataAiHint: 'hr it', pricing: 'Paid' },
        ]
    },
];
